...
module "kms-key-rotation-disabled" {
  source            = "git::https://github.com/reflexivesecurity/reflex-aws-kms-key-rotation-disabled.git?ref=latest"
...
## License
This Reflex rule is made available under the MPL 2.0 license. For more information view the [LICENSE](https://github.com/reflexivesecurity/reflex-aws-kms-key-rotation-disabled/blob/master/LICENSE) 
